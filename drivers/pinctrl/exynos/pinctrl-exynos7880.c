...
static struct pinctrl_ops exynos7880_pinctrl_ops = {
...
static const struct udevice_id exynos7880_pinctrl_ids[] = {
	{ .compatible = "samsung,exynos7880-pinctrl",
		.data = (ulong)exynos7880_pin_ctrl },
	{ }
};

U_BOOT_DRIVER(pinctrl_exynos7880) = {
	.name		= "pinctrl_exynos7880",
	.id		= UCLASS_PINCTRL,
	.of_match	= exynos7880_pinctrl_ids,
	.priv_auto_alloc_size = sizeof(struct exynos_pinctrl_priv),
	.ops		= &exynos7880_pinctrl_ops,
